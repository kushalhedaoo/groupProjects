...
//	setbkcolor(4);
	...
	setcolor(LIGHTGREEN);
	outtextxy(100,230," MADE BY .... ");
	setcolor(LIGHTGREEN);
	settextstyle(8,HORIZ_DIR,5);
	outtextxy(i,320+j," KUSHAL HEADOO ");
	setcolor(LIGHTRED);
	...
	setcolor(LIGHTCYAN);
	settextstyle(8,HORIZ_DIR,5);
	outtextxy(100,480+j,"UNDER THE GUIDANCE OF : ARCHANA SAID MAM");
	setcolor(LIGHTBLUE);
	setcolor(WHITE);
...
//	TRUTH TABLE BORDER
	...
	setcolor(WHITE);
	outtextxy(250,600+70,"PRESS ENTER TO RETURN MENU ");
...
//	floodfill(60,25,LIGHTBLUE);
	...
	setcolor(LIGHTBLUE);
	outtextxy(180,350,"KEY     A           OUTPUT ");
	setcolor(CYAN); 
	outtextxy(180,376,"--------------------------------------");
	setcolor(LIGHTGREEN);
	outtextxy(180,400,"  1.      ON         OFF   ");
	setcolor(CYAN);
	outtextxy(180,426,"--------------------------------------");
	setcolor(LIGHTRED);
	outtextxy(180,450,"  2.      OFF        ON  ");
	setcolor(CYAN);
	outtextxy(180,476,"--------------------------------------");
...
//	NAND GATE DESIGN 
	...
	settextstyle(4,HORIZ_DIR,4);
	setcolor(WHITE);
	outtextxy(240,280,"Expression : Y = (AB'+A'B) or A ^ B ");
	// TEXT BOX 
	setcolor(LIGHTRED);
...
int main ()
{
	initwindow(1300,750,"LOGICAL AND GATE ");
	startpage();
	while(1)
	{
		// RETURN TO MENU
